...
public:
    ...
    void solve_self_consistent_Q(double Q_p, int zero_displacement, int zero_momentum);

    void simulate_quench(unsigned long saved_steps, int pre_steps, double dt, int save_interval, int save_mid_interval, std::filesystem::path directory, int sim_num, int phase);
